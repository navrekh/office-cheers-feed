    ...
    >
      <div className="flex items-center gap-2 min-w-0">
        <span className="relative flex h-2 w-2 shrink-0">
          <span className="absolute inline-flex h-full w-full animate-soft-breathe rounded-full bg-emerald-400/60" />
        ...
        >
          <span className={`h-1.5 w-1.5 rounded-full bg-red-500 ${pulse ? "animate-soft-breathe" : ""}`} />
          LIVE
        </span>
      </div>
      {typingLabel && (
        <div className="hidden sm:flex items-center gap-1.5 text-[11px] text-amber-300/80 italic truncate min-w-0">
          <span className="inline-flex gap-0.5">
            <span className="h-1 w-1 rounded-full bg-amber-300/70 animate-typing-drift [animation-delay:-0.5s]" />
            <span className="h-1 w-1 rounded-full bg-amber-300/70 animate-typing-drift [animation-delay:-0.25s]" />
            <span className="h-1 w-1 rounded-full bg-amber-300/70 animate-typing-drift" />
          </span>
